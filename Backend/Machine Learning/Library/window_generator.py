...
class WindowGenerator():
    def __init__(self, input_width, label_width, shift,
        ...
        :param input_width: The number of inputs (previous values)
        :param label_width: The different amount of values to predict.
        :param shift: The number of steps to predict.
